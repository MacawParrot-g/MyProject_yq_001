...
public class DatabaseController {
    ...
    public Map<String, Object> insertRecord(@RequestBody TestStatic record) {
        try {
            ...
            return Map.of("success", true, "resultMsg", "入库请求已接收，正在异步处理");
        } catch (Exception e) {
    ...
    public Result getRecordList(
        ...
        try {
            return databaseService.queryByPage(ascribe, frozen, recorder, page, size);
        } catch (Exception e) {
    ...
    public Result deleteRecord(@RequestParam String url) {
        try {
            databaseService.submitDeleteAsync(url);
