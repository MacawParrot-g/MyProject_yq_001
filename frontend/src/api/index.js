...
export function fetchAppGrade(url) {
    return fetchWithTimeout('/api/grade/query?url=' + encodeURIComponent(url), {}, 10000).then(safeJson)
}

export function saveAppGrade(url, grade, recorder, remark) {
